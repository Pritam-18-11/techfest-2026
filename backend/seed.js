...
const GALLERY = [
  { caption: "Opening Ceremony, Main Stage", year: "2025", gradient: "from-signal-blue to-signal-purple" },
  { caption: "HackFusion — Overnight Build Floor", year: "2025", gradient: "from-signal-purple to-signal-magenta" },
  { caption: "RoboWars Grand Final", year: "2025", gradient: "from-signal-magenta to-signal-cyan" },
  { caption: "Keynote: Scaling Foundation Models", year: "2024", gradient: "from-signal-cyan to-signal-blue" },
  { caption: "Drone Racing Championship", year: "2024", gradient: "from-signal-blue to-signal-magenta" },
  { caption: "Startup Pitch Arena Finals", year: "2024", gradient: "from-signal-purple to-signal-blue" },
  { caption: "Cyber Shield CTF War Room", year: "2023", gradient: "from-signal-magenta to-signal-purple" },
  { caption: "Closing Fireworks", year: "2023", gradient: "from-signal-cyan to-signal-purple" },
];

async function seed() {
  await connectDB();

  console.log("[seed] Clearing existing Events, Sponsors, and Gallery items...");
  await Promise.all([
    Event.deleteMany({}),
    Sponsor.deleteMany({}),
